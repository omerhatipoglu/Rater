...
var Core = function (options) {
    ...
    var DefineLoadingPanelOptions = function () {
        opt.loadingPanel.loadingPanelTemp = core.IsNullOrEmpty(options.loadingPanel.loadingPanelTemp) ? opt.loadingPanel.loadingPanelTemp : options.loadingPanel.loadingPanelTemp;
        opt.loadingPanel.loadingPanelid = core.IsNullOrEmpty(options.loadingPanel.loadingPanelTemp) ? opt.loadingPanel.loadingPanelid : (core.IsNullOrEmpty(options.loadingPanel.loadingPanelid) ? $(opt.loadingPanel.loadingPanelTemp).attr("id") : options.loadingPanel.loadingPanelid);
        opt.loadingPanel.loadingMessage = core.IsNullOrEmpty(options.loadingPanel.loadingMessage) ? opt.loadingPanel.loadingMessage : options.loadingPanel.loadingMessage;
        opt.loadingPanel.loadingPanelTemp.replace("#LOADING", opt.loadingPanel.loadingMessage);
    }
    ...
    var LoadingPanel = function () {
        ...
        panel.Show = function () {
            panel.Close();
            $("body").append(opt.loadingPanel.loadingPanelTemp);
        }
...
var CorePureJs = function (options) {
    ...
    var DefineLoadingPanelOptions = function () {
        var loadingTempDoc = new DOMParser().parseFromString(opt.loadingPanel.loadingPanelTemp, "text/xml");

        opt.loadingPanel.loadingPanelTemp = core.IsNullOrEmpty(options.loadingPanel.loadingPanelTemp) ? opt.loadingPanel.loadingPanelTemp : options.loadingPanel.loadingPanelTemp;
        opt.loadingPanel.loadingPanelid = core.IsNullOrEmpty(options.loadingPanel.loadingPanelTemp) ? opt.loadingPanel.loadingPanelid : (core.IsNullOrEmpty(options.loadingPanel.loadingPanelid) ? loadingTempDoc.firstElementChild.getAttribute("id") : options.loadingPanel.loadingPanelid);
        opt.loadingPanel.loadingMessage = core.IsNullOrEmpty(options.loadingPanel.loadingMessage) ? opt.loadingPanel.loadingMessage : options.loadingPanel.loadingMessage;
        opt.loadingPanel.loadingPanelTemp.replace("#LOADING", opt.loadingPanel.loadingMessage);
    }

    var DefineToasterOptions = function () {
        var toasterTempDoc = new DOMParser().parseFromString(opt.toaster.toasterTemp, "text/xml");

        opt.toaster.toasterTemp = core.IsNullOrEmpty(options.toaster.toasterTemp) ? opt.toaster.toasterTemp : options.toaster.toasterTemp;
        opt.toaster.toasterid = core.IsNullOrEmpty(options.toaster.toasterTemp) ? opt.toaster.toasterid : (core.IsNullOrEmpty(options.toaster.toasterid) ? toasterTempDoc.firstElementChild.getAttribute('id') : options.toaster.toasterid);
        opt.toaster.toasterMessageid = core.IsNullOrEmpty(options.toaster.toasterTemp) ? opt.toaster.toasterMessageid : (core.IsNullOrEmpty(options.toaster.toasterMessageid) ? opt.toaster.toasterMessageid : options.toaster.toasterMessageid);
        opt.toaster.fadeInTime = !options.toaster.fadeInTime ? opt.toaster.fadeInTime : options.toaster.fadeInTime;
        opt.toaster.fadeOutTime = !options.toaster.fadeOutTime ? opt.toaster.fadeOutTime : options.toaster.fadeOutTime;
        opt.toaster.showTime = !options.toaster.showTime ? opt.toaster.showTime : options.toaster.showTime;
    ...
    var LoadingPanel = function () {
        ...
        panel.Show = function () {
            ...
            var loadingPanelDoc = new DOMParser().parseFromString(opt.loadingPanel.loadingPanelTemp, "text/xml");
            bodyElement.item(0).appendChild(loadingPanelDoc.firstChild);
            $("body").append(opt.loadingPanel.loadingPanelTemp);
        }
